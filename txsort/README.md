...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/firobridge/btcutil/txsort)
...
```bash
$ go get -u github.com/firobridge/btcutil/txsort
```
